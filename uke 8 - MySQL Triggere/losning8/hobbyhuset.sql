...
INSERT INTO bruker (epost, passord, fornavn, etternavn, er_ansatt) VALUES
...
CREATE TABLE IF NOT EXISTS ordrelinje (
  ...
  KEY ordrelinje_vare_fk (varekode)
) ENGINE=InnoDB;
...
INSERT INTO ordrelinje (ordrenr, varekode, pris_pr_enhet, antall) VALUES
(1, '10830', '29.90', 1),
(1, '65081', '109.50', 5),
(2, '10830', '29.90', 1),
(2, '21032', '57.60', 3),
...
INSERT INTO vare (varekode, betegnelse, pris_pr_enhet, lager_antall, er_aktiv) VALUES
...
--
ALTER TABLE ordre
  ADD CONSTRAINT ordre_bruker_fk FOREIGN KEY (bnr) REFERENCES bruker (bnr);

--
-- Begrensninger for tabell ordrelinje
--
ALTER TABLE ordrelinje
  ADD CONSTRAINT ordrelinje_ordre_fk FOREIGN KEY (ordrenr) REFERENCES ordre (ordrenr),
  ADD CONSTRAINT ordrelinje_vare_fk FOREIGN KEY (varekode) REFERENCES vare (varekode);
