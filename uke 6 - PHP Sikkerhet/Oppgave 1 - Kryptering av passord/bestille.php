...
if (!isset($_SESSION["brukernavn"])) {
  ...
  if (isset($_REQUEST["brukernavn"]) && isset($_REQUEST["passord"])) {
    ...
    $brukernavn = mysqli_real_escape_string($connect, $_REQUEST["brukernavn"]);
    $passord= mysqli_real_escape_string($connect, $_REQUEST["passord"]);
...
if ($ok) {
	...
	<form action="" method="POST" accept-charset="utf-8">
		...
		<p>
			...
			<input type="button" onclick="location.href='endrepassord.php';" Value="Endre Passord">
			<input type="button" onclick="location.href='loggut.php';" value="Logg Ut">
		</p>
	</form>
